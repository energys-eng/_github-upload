...
function IconCard({ item }: { item: CardItem }) {
  ...
  return (
    <article className="rounded-lg border border-slate-200 bg-white p-6 shadow-[0_12px_36px_rgba(16,32,51,0.06)]">
      <div className="mb-5 flex h-12 w-12 items-center justify-center rounded-md bg-energys-mist text-energys-blue">
        <Icon className="h-6 w-6" aria-hidden="true" />
      </div>
      <h3 className="text-xl font-semibold text-energys-navy">{item.title}</h3>
...
export default function HomePage() {
  return (
    <>
      ...
      <Header />
      <main id="conteudo">
        <section id="inicio" className="relative overflow-hidden bg-energys-mist">
          ...
          <div className="relative mx-auto grid max-w-7xl gap-8 px-5 pb-16 pt-10 sm:pt-14 lg:grid-cols-[1.08fr_0.92fr] lg:px-8 lg:pb-20 lg:pt-16">
            <div className="flex flex-col justify-center">
              <p className="mb-5 w-fit rounded-md border border-energys-blue/15 bg-white px-3 py-2 text-sm font-semibold uppercase text-energys-blue">
                Engenharia e inteligência energética
              </p>
              <h1 className="max-w-4xl text-4xl font-semibold leading-[1.08] text-energys-navy sm:text-5xl xl:text-6xl">
              ...
              <div className="mt-7 flex flex-col gap-3 sm:flex-row">
                <a
                  href="#lead-form-hero"
                  className="inline-flex h-12 items-center justify-center gap-2 rounded-md bg-energys-yellow px-5 text-sm font-bold text-energys-navy transition hover:bg-[#f5a414] focus:outline-none focus:ring-4 focus:ring-energys-yellow/35"
                >
                ...
                <a
                  href="#contato"
                  className="inline-flex h-12 items-center justify-center gap-2 rounded-md border border-energys-blue/20 bg-white px-5 text-sm font-bold text-energys-navy transition hover:border-energys-blue/40 hover:text-energys-blue focus:outline-none focus:ring-4 focus:ring-energys-blue/15"
                >
            ...
            <div className="grid gap-3 sm:grid-cols-3 lg:col-start-1 lg:row-start-2">
              {heroHighlights.map((item) => (
                <div
                  key={item}
                  className="flex min-h-16 items-start gap-3 rounded-md border border-white/80 bg-white/85 p-3 shadow-[0_8px_24px_rgba(16,32,51,0.05)]"
                >
                  <CheckCircle2 className="mt-0.5 h-4 w-4 shrink-0 text-energys-blue" />
        ...
        <section id="para-quem" className="bg-white py-20 lg:py-24">
        ...
        <section className="bg-energys-mist py-20 lg:py-24">
        ...
        <section id="solucoes" className="bg-white py-20 lg:py-24">
          <div className="mx-auto max-w-7xl px-5 lg:px-8">
            <SectionHeading
              eyebrow="Soluções"
            ...
            />
            <div className="mt-8 rounded-lg border border-energys-blue/10 bg-energys-mist p-5 text-sm leading-6 text-slate-700">
        ...
        <section id="metodo" className="bg-energys-navy py-20 text-white lg:py-24">
          <div className="mx-auto max-w-7xl px-5 lg:px-8">
            ...
            <div className="mt-12 grid gap-4 md:grid-cols-2 xl:grid-cols-5">
              {methodSteps.map((step, index) => (
                <article
                  key={step.title}
                  className="rounded-lg border border-white/12 bg-white/[0.06] p-5 shadow-[0_18px_50px_rgba(0,0,0,0.16)]"
                >
          ...
          <div className="mx-auto grid max-w-7xl gap-10 px-5 lg:grid-cols-[0.92fr_1.08fr] lg:px-8">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              {trustItems.map((item) => (
                <div
                  key={item}
                  className="flex gap-3 rounded-lg border border-slate-200 bg-energys-mist p-5"
                >
        ...
        <section id="duvidas" className="bg-energys-mist py-20 lg:py-24">
      ...
      <footer className="bg-energys-navy text-white">
